(defrule grid-values
   ...
   (assert (possible (row 2) (column 5) (diagonal 2) (value 3) (group 2) (id 11)))
   ...
   (assert (possible (row 3) (column 4) (diagonal 2) (value 4)   (group 4) (id 19)))
   ...
   (assert (possible (row 6) (column 1) (diagonal 2) (value any)   (group 5) (id 28)))
