(defrule grid-values
   ...
   (assert (possible (row 1) (diagonal 2) (column 6) (value 2) (group 2) (id 9)))
   (assert (possible (row 2) (column 4) (value any) (group 2) (id 10)))
   (assert (possible (row 2) (diagonal 2) (column 5) (value any) (group 2) (id 11)))
   ...
   (assert (possible (row 3) (column 3) (diagonal 1) (value any) (group 3) (id 15)))
   (assert (possible (row 4) (column 1) (value any)   (group 3) (id 16)))
   (assert (possible (row 4) (column 2) (value 5)   (group 3) (id 17)))
   (assert (possible (row 4) (diagonal 2) (column 3) (value 6)   (group 3) (id 18)))

   (assert (possible (row 3) (diagonal 2) (column 4) (value 5)   (group 4) (id 19)))
   ...
   (assert (possible (row 5) (diagonal 2)(column 2) (value any) (group 5) (id 26)))
   (assert (possible (row 5) (column 3) (value any) (group 5) (id 27)))
   (assert (possible (row 6) (diagonal 2) (column 1) (value any)   (group 5) (id 28)))
   ...
   (assert (possible (row 5) (diagonal 1) (column 5) (value any)   (group 6) (id 32)))
   ...
   (assert (possible (row 6) (diagonal 1) (column 6) (value any) (group 6) (id 36))))